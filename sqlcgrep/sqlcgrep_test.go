...
packages:
  - name: "dbmodel"
    path: "internal/pkg/dbmodel"
    schema: "structure.sql"
    queries: "internal/pkg/dbmodel/query.sql"
    engine: "postgresql"
    replaces:
  ...
  - name: "testdbmodel"
    path: "internal/test/testdbmodel"
    queries: "internal/test/testdbmodel/query.sql"

  - name: "extradbmodel"
    path: "internal/test/extradbmodel"
    queries: "internal/test/extradbmodel/query.sql"
`,
			wantFiles: map[string]string{
				"internal/pkg/dbmodel/db.go": `
// Code generated by sqlc. DO NOT EDIT.
